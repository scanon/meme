package Bio::KBase::meme::Service;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::meme::ServiceContext->new(client_ip => $self->_plack_req->address);
    
    my $args = $data->{arguments};

    # Service GeneralTypes does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service GeneralTypes.");
    }
...
package Bio::KBase::meme::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::meme::ServiceContext
