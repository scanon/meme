...
print " \n";
print "EXAMPLES \n";
print "compare_motifs_with_tomtom_job_by_collection_from_ws --url=http://140.221.85.173:7077/ --ws=AKtest --query=\"kb|memepspmcollection.2\" --target=\"kb|memepspmcollection.2\" --thresh=0.0000001 --evalue --dist=pearson --internal --min_overlap=12\n";
print "\n";
