...
compare_motifs_with_tomtom_by_collection_from_ws - find motifs that are similar to a given DNA motif by searching a database of known motifs.
...
if($version)
{
    print "compare_motifs_with_tomtom_by_collection_from_ws\n";
