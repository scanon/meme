...
find_sites_with_mast_job_by_collection_from_ws [--url=http://140.221.85.173:7077/ --ws=<workspace name> --query=<MemePSPMCollection reference> --target=<sequence set reference> --matrix=<PSPM ID> --mt=<mt>]
...
my $usage = "Usage: find_sites_with_mast_job_by_collection_from_ws [--url=http://140.221.85.173:7077/ --ws=<workspace name> --query=<MemePSPMCollection reference> --target=<sequence set reference> --matrix=<PSPM ID> --mt=<mt>]\n";
...
print "\n";
print "SYNOPSIS\n";
print "find_sites_with_mast_job_by_collection_from_ws [--url=http://140.221.85.173:7077/ --ws=<workspace ID> --query=<MemePSPMCollection ID> --target=<sequence set ID> --matrix=<PSPM ID> --mt=<mt>]\n";
print "\n";
print "DESCRIPTION\n";
