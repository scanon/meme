...
find_sites_with_mast_from_ws - search a sequence database for occurences of known motifs by MAST

=head1 SYNOPSIS

find_sites_with_mast_from_ws [--url=http://140.221.84.195:7049/ --ws=<workspace ID> --query=<MemePSPM ID> --target=<sequence set ID> --mt=<mt> --user=<username> --pw=<password>]
...
find_sites_with_mast_from_ws --url=http://140.221.84.195:7049/ --ws=AKtest --query="kb|memepspm.1" --target="KBase.SequenceSet.12345" --mt=0.001 
find_sites_with_mast_from_ws --help
find_sites_with_mast_from_ws --version
...
my $usage = "Usage: find_sites_with_mast_from_ws [--url=http://140.221.84.195:7049/ --ws=<workspace ID> --query=<MemePSPM ID> --target=<sequence set ID> --mt=<mt> --user=<username> --pw=<password>]\n";
...
if($help){
print "NAME\n";
print "find_sites_with_mast_from_ws - search a sequence database for occurences of known motifs by MAST.\n";
print "\n";
print "\n";
print "VERSION\n";
print "1.0\n";
print "\n";
print "SYNOPSIS\n";
print "find_sites_with_mast_from_ws [--url=http://140.221.84.195:7049/ --ws=<workspace ID> --query=<MemePSPM ID> --target=<sequence set ID> --mt=<mt> --user=<username> --pw=<password>]\n";
print "\n";
print "DESCRIPTION\n";
...
print " \n";
print "EXAMPLES \n";
print "find_sites_with_mast_from_ws --url=http://140.221.84.195:7049/ --ws=AKtest --query=\"kb|memepspm.1\" --target=\"KBase.SequenceSet.12345\" --mt=0.001\n";
print "\n";
print "This command will return KBase ID of a list of occurences of PSPM in the set of sequences with p-value below 0.001.\n";
print "\n";
print " \n";
...
if($version)
{
    print "find_sites_with_mast_from_ws\n";
...
my $obj = {
	method => "MEME.find_sites_with_mast_from_ws",
